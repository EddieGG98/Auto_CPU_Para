...
parser.add_argument("--accname", type=str, default="tmp_1.png", help="The name of the ACC curve")
...
nets_value = [
    Tri_MLP(input_size1 = L,
            ...
            hidden_dim2 = 256,
            hidden_dim3 = 256,
            output_dim  = 1          ).to("cuda") for _ in range(5)]
...
agents =  [starter(L, [1,2      ], agent_encs, nets_value[0], None          )] \
        + [loader1(L, [1,2,4    ], agent_encs, nets_value[1], nets_action[0])] \
        + [loader2(L, [1,2,4    ], agent_encs, nets_value[2], nets_action[1])] \
        + [writer (L, [1,2,3,4,5], agent_encs, nets_value[3], nets_action[2])] \
        + [alu    (L, [1,2,3,4  ], agent_encs, nets_value[4], nets_action[3])]
