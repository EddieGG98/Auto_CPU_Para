...
from agents import starter, swaper, alu, pm
...
nets_value = [
    Tri_MLP(input_size1 = L,
            ...
            hidden_dim2 = 256,
            hidden_dim3 = 256,
            output_dim  = 1          ).to("cuda") for _ in range(4)]
...
agents =  [starter(L, [1,2  ], agent_encs, nets_value[0], None          )] \
        ...
        + [pm     (L, [1,2,3], agent_encs, nets_value[2], nets_action[2])]
    ...
    for episode in range(EPISODE_NUM):
        ...
        for k in range(EPISODE_SIZE):
            ...
            for t in range(1, T+1):
                ...
                distance_records.append(abs(ans-reg.data[0]))
